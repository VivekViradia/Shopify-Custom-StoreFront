          ...
          <>
            {data?.totalQuantity > 0 ? (
              <>
                ...
                <div className="w-full md:px-12 px-4 py-6 space-y-6 border border-1 broder-gray-00">
